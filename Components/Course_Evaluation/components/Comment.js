...
export default class Comment extends Component{
    ...
    render(){
        ...
        if(this.state.ismineComment) {
            ...
            TopRight.push(
                <View key={0} style={styles.ViewA}>
                        <TouchableOpacity style={[{paddingRight : 10,},styles.personName]}>
        ...
        Like.push(
            <View key={0} style={styles.TopRightView}>
                        <View style={{flexDirection : 'row'}}>
                             <Text style={{fontSize : 15}}>{this.state.NumberLike}</Text>
                        </View>
